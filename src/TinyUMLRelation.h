// TinyUMLRelation.h: interface for the CTinyUMLRelation class.
//
//////////////////////////////////////////////////////////////////////
...
class CTinyUMLRelation : public CTinyUMLEntity  
{
	DECLARE_SERIAL(CTinyUMLRelation)
protected:
	struct Anchor
	{
		CTinyUMLEntity *pEnt;
...
public:
	...
	virtual bool Finish(const CPoint &point, CTinyUMLEntity *pEnt);
	virtual void destTransform(CPoint p[], long count) const;
	virtual void srcTransform(CPoint p[], long count) const;
	virtual void Copy(CTinyUMLRelation* pTinyUMLRelation);
	virtual void SetupTheme(CTinyDrawTheme *pTheme);
	CTinyUMLRelation(CIsDrawEntContainer* pDoc,CIsControllerObject* pController,const CPoint &point, CTinyUMLEntity *pEnt);
	virtual ~CTinyUMLRelation();
