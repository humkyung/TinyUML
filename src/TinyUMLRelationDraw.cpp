// TinyUMLRelationDraw.cpp: implementation of the CTinyUMLRelationDraw class.
//
//////////////////////////////////////////////////////////////////////
...
IS_IMPLEMENT_DRAW_FUNC(CTinyUMLRelationDraw)
//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CTinyUMLRelationDraw::CTinyUMLRelationDraw()
{
 ...
 * @return void 
 */
void CTinyUMLRelationDraw::DrawObject(CDC *pDC, CIsDrawEntity *pEnt, CIsDrawEntContainer *pDoc , const CIsDrawEditor* pDrawEditor)
{
	CTinyUMLRelation* pRel = static_cast<CTinyUMLRelation*>(pEnt);
	if(pRel->IsCreated())
	{
 ...
 * @return void 
 */
void CTinyUMLRelationDraw::DrawFocusObject(CDC *pDC, CIsDrawEntity *pEnt, CIsDrawEntContainer *pDoc , const CIsDrawEditor* pDrawEditor)
{
	CTinyUMLRelation* pRel = static_cast<CTinyUMLRelation*>(pEnt);
	if(pRel->IsCreated())
	{
 ...
 * @return void 
 */
void CTinyUMLRelationDraw::DrawSelectionMarkers(CDC *dc, CIsDrawEntity *pEnt , const CIsDrawEditor* pDrawEditor) const
{
	/// do nothing
}
 ...
 * @return void 
 */
void CTinyUMLRelationDraw::DrawTracker(CDC *pDC, CIsDrawEntity *pEnt, CIsDrawEntContainer *pDoc , const CIsDrawEditor* pDrawEditor) const
{
	CTinyUMLRelation* pRel = static_cast<CTinyUMLRelation*>(pEnt);
	assert(NULL != pRel);
